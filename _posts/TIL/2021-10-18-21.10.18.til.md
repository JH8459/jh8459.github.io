---
layout: post
title: 1. ORM 2. Sequelize 3. Short.ly MVC
subtitle: "CodeStates FullStack 부트캠프"
category: TIL
tags: [ORM, Sequelize, Design Patterns, CodeStates]
---
...
당장 많이 써보지 않아 익숙하지 않아 코드를 짤 때 느끼는 이질감은 당연히 있지만, 이 백엔드 로직은 충분히 학습해야겠다 라는 생각이 들었다. <br>
